...
dependencies {
    ...
    // material3 no longer pulls this in transitively as of compose-bom 2026.09.00 — needed
    // explicitly for androidx.compose.material.icons.* (Icons.Default.*, Icons.AutoMirrored.*).
